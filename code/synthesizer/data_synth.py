...
params = {
    # MAIN CONFIGURATION =============================
    "NAME": "numbers_8px",  # Name of the dataset
    "TYPE": "random",  # Which algorithm to use
    "N_IMAGES": 200000,  # How many images to generate
    ...
    "MIN_FONT": 22,  # Smallest font used
    "MAX_FONT": 28,  # Largest font used
    "FONTS": ["arial.ttf"],  # Fonts used
    # PIXELATION DETAILS =============================
    ...
    "CHARSET": NUMBERS,  # Characters used for strings
